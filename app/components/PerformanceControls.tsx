        ...
        <div className="flex flex-col">
          ...
          <div className="inline-flex rounded-md shadow-sm bg-gray-100">
            <button
              ...
              className={`px-3 py-2 text-sm border-r rounded-l-md focus-visible:ring-2 focus-visible:outline-none focus-visible:z-10 ${metric === 'winPercentage' ? 'bg-gray-900 text-white border-gray-900' : 'bg-transparent text-gray-700 border-transparent'}`}
            >
              Win %
            </button>
            <button
              ...
              className={`px-3 py-2 text-sm rounded-r-md focus-visible:ring-2 focus-visible:outline-none focus-visible:z-10 ${metric === 'totalWins' ? 'bg-gray-900 text-white border-gray-900' : 'bg-transparent text-gray-700 border-transparent'}`}
            >
              Total Wins
            </button>
          </div>
