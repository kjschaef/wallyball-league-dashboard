...
export function FloatingActionButton({ onRecordMatch, onAddPlayer }: FloatingActionButtonProps) {
  const [showDropdown, setShowDropdown] = useState(false);

  const handleOptionClick = (action: 'addPlayer' | 'recordMatch') => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      {showDropdown && (
        <div className="absolute bottom-16 right-0 bg-white rounded-lg shadow-lg border border-gray-200 py-2 min-w-[140px] mb-2">
          <button
