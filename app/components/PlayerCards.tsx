          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-4 text-sm text-gray-600">
              <div className="flex items-center gap-1">
                ...
                <span>{player.yearsPlayed} {player.yearsPlayed === 1 ? 'year' : 'years'}</span>
              </div>
              <div className="flex items-center gap-1">
          ...
          <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
            ...
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <button className="p-2 hover:bg-red-50 rounded-lg transition-colors shadow-sm" title="Delete player">
      ...
      <CardContent className="relative pt-0 space-y-6">
        ...
        <div className="text-center">
          <div className="relative inline-block">
            <div className={`text-4xl font-bold bg-gradient-to-r ${getWinPercentageGradient(player.winPercentage)} bg-clip-text text-transparent`}>
        ...
        {showInactivityPenalty && (
          <div className="bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200 rounded-xl p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-sm font-medium text-amber-800">Inactivity Penalty</p>
            </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-white/60 rounded-xl p-4 border border-gray-100">
            ...
            <div className="flex items-center justify-center gap-2">
              <span className="text-lg font-bold text-emerald-600">{player.record.wins}</span>
          ...
          <div className="bg-white/60 rounded-xl p-4 border border-gray-100">
            ...
            <div className="text-center">
              <span className="text-lg font-bold text-blue-600">{player.totalPlayingTime}</span>
        ...
        <div className="bg-white/60 rounded-xl p-4 border border-gray-100">
          ...
          <div className="flex items-center justify-between">
            <span className="text-lg font-bold text-gray-900">{player.streak.count} weeks</span>
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {Array.from({ length: 6 }).map((_, index) => (
            <Card key={index} className="p-6 animate-pulse bg-gradient-to-br from-gray-50 to-gray-100">
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="p-6 border border-red-200 rounded-xl bg-gradient-to-r from-red-50 to-rose-50">
          <p className="text-red-800 font-medium">Failed to load player statistics. Please try again later.</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="p-12 text-center border border-gray-200 rounded-xl bg-gradient-to-br from-gray-50 to-gray-100">
          <p className="text-gray-600 text-lg">No players found. Add some players to see their statistics.</p>
        </div>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="bg-white border-0 shadow-2xl">
          <DialogHeader>
            <DialogTitle className="text-2xl font-bold text-gray-900">Edit Player</DialogTitle>
          </DialogHeader>
