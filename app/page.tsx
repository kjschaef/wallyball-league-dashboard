  ...
  return (
    <div className="max-w-7xl mx-auto p-4 sm:p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className={`space-y-6 lg:col-span-8 ${mobileTab === 'season' ? 'block' : 'hidden lg:block'}`}>
        ...
        <div className={`lg:col-span-4 ${mobileTab === 'elo' ? 'block' : 'hidden lg:block'}`}>
          <PowerRankings key={`power-${refreshKey}`} />
        </div>
      </div>
