...
async function main() {
  ...
  // Note: We use Drizzle's native delete() to avoid raw SQL execution bugs with Neon HTTP's tagged-template expectations.
  // Order matters here to respect foreign key constraints.
